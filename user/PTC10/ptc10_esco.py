...
def myPTC10EscoPlan(pos_X, pos_Y, thickness, scan_title, delay_minutes=10, md={}):
    ...
    def _ramp_and_hold_measurement(pr,tc):
        ...
        yield from bps.mv(ptc10.temperature.setpoint, tc)          #Change the temperature and not wait
        ...
        checkpoint = time.time() + delay_minutes*MINUTE                     # time to end  after``delayAtPressureinMin`` hold period   
